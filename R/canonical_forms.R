...
#' Obtain linear parameters of model by Lubik and Marzo (2007) equation (26)
#'
#' This function returns a DSGE model as described in  used in \href{https://doi.org/10.1016/j.iref.2004.09.008}{Lubik Marzo (2007)}.
...
#'
#' @return List object containing the parameter matrices \eqn{\Gamma_0, \Gamma_1, \Psi, \Pi} as list objects.
#' @export
#'
linear_parameters_LM_26_0 <- function(s = 1, b = 0.99, k = 0.5, f_y = 0.8, f_p = 0.7, f_r = 1.2){
